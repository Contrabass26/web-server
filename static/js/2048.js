...
function runApplication() {
    ...
    var o = document.querySelector(".how-to-play-link"), n = document.querySelector(".game-explanation");
    o && n && o.addEventListener("click", (function () {
        n.scrollIntoView({behavior: "smooth", block: "center"}), n.addEventListener("animationend", (function () {
            n.classList.remove("game-explanation-highlighted")
        })), n.classList.add("game-explanation-highlighted")
    }));
    var a = document.querySelector(".start-playing-link"), r = document.querySelector(".game-container");
...
Function.prototype.bind = Function.prototype.bind || function (e) {
    ...
    var e, t, i = this, o = {38: 0, 39: 1, 40: 2, 37: 3, 75: 0, 76: 1, 74: 2, 72: 3, 87: 0, 68: 1, 83: 2, 65: 3};
    document.addEventListener("keydown", (function (e) {
        var t = e.altKey || e.ctrlKey || e.metaKey || e.shiftKey, n = o[e.which];
    ...
    n.addEventListener(this.eventTouchstart, (function (o) {
    ...
    }), {passive: !0}), n.addEventListener(this.eventTouchmove, (function (e) {
        e.preventDefault()
    }), {passive: !0}), n.addEventListener(this.eventTouchend, (function (o) {
        if (!(!window.navigator.msPointerEnabled && o.touches.length > 0 || o.targetTouches.length > 0 || i.targetIsInput(o))) {
            ...
            var r = n - e, s = Math.abs(r), c = a - t, l = Math.abs(c);
    ...
    var t = this, i = document.createElement("div"), o = document.createElement("div"),
        n = e.previousPosition || {x: e.x, y: e.y}, a = this.positionClass(n), r = ["tile", "tile-" + e.value, a];
    ...
    var t = e ? "game-won" : "game-over", i = e ? "You win!" : "Game over!";
    ...
    for (var t = [], i = 0; i < this.size; i++) for (var o = t[i] = [], n = 0; n < this.size; n++) {
        var a = e[i][n];
    ...
    if (this.grid.cellsAvailable()) {
        var e = Math.random() < .9 ? 2 : 4, t = new Tile(this.grid.randomAvailableCell(), e);
        ...
        this.prepareTiles(), a.x.forEach((function (e) {
            a.y.forEach((function (a) {
                if (i = {x: e, y: a}, o = t.grid.cellContent(i)) {
                    var s = t.findFarthestPosition(i, n), c = t.grid.cellContent(s.next);
    ...
    for (var e, t = 0; t < this.size; t++) for (var i = 0; i < this.size; i++) if (e = this.grid.cellContent({
        ...
        var n = this.getVector(o), a = {x: t + n.x, y: i + n.y}, r = this.grid.cellContent(a);
